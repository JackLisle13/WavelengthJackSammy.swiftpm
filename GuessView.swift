    ...
    var body: some View {
        NavigationStack {
            VStack {
                ...
                NavigationLink() {
                    PointsView(guess: guess, random: random, playerNum: playerNum, prompts: prompts, offset: offset, totalScore: $totalScore)
...
#Preview {
    GuessView(random: 74.0, playerNum: 2, prompts: Prompts(), offset: 0.0, totalScore: .constant(0))
}
